  ...
  return (
    <div className="post">
      <div className="postheader">
        ...
        <button
          onClick={() => {
            props.onDelComment(props.postid, props.username, props.timestamp);
          }}
          className="RedBtn"
        >
          <FontAwesomeIcon icon={faTrashAlt} />
  ...
  const onDelPost = (id) => {
    ...
    fetch("https://bmpi7pfcqk.execute-api.eu-west-1.amazonaws.com/Prod/postdelete", {
      ...
      .then(async (response) => {
        ...
        let newallPost = { ...allPost };
        newallPost["Items"] = newallPost["Items"].filter((post) => {
