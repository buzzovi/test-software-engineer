...
def test_lambda_post_create(post_create_event):
    ...
    blog.post_delete({"queryStringParameters": {"id": data["id"]}}, "")
...
def test_lambda_post_delete(post_create_event):

    ret = blog.post_create(post_create_event, "")
    data = json.loads(ret["body"])
    
    ret = blog.post_delete({"queryStringParameters": {"id": data["id"]}}, "")
    data = json.loads(ret["body"])
...
def test_lambda_comment_create(post_create_event):

    ret = blog.post_create(post_create_event, "")
    data = json.loads(ret["body"])
    
    ret = blog.comment_create({"queryStringParameters": {"postid": data["id"],"username": "B","comment": "Comment!!!2"}}, "")
    data = json.loads(ret["body"])
...
def test_lambda_comment_delete(post_create_event):
    ret = blog.post_create(post_create_event, "")
    data = json.loads(ret["body"])
    
    ret = blog.comment_create({"queryStringParameters": {"postid": data["id"],"username": "B","comment": "Comment!!!2"}}, "")
    dataC = json.loads(ret["body"])

    ret = blog.comment_delete({"queryStringParameters": {"id": data["id"],"username": dataC["username"],"timestamp": dataC["timestamp"]}}, "")
    data = json.loads(ret["body"])
